...
urlpatterns = [
    ...
    #
    path("o/<id>/", OrgView.as_view({"get": "retrieve"}), name="org"),
    path("o/<slug:org>/c/", ChannelView.as_view({"get": "list_for_org", "post":"post"}), name="org-channel-list"),
    #
    ...
    path("o/<slug:org>/p/<slug:prj>/c/", ChannelView.as_view({"get": "list_for_project", "post":"post"}), name="project-channel-list"),
    #
    #
    path(
    ...
    path("o/<slug:org>/p/<slug:prj>/d/", DistributionView.as_view({"get": "list", "post" : "post"}), name="distribution-list"),
    #
